...
FINANCE_EMAILS = config.FINANCE_EMAILS
REFERENT_EMAILS = config.REFERENT_EMAILS

##########
# QPILOT #
##########
QPILOT_USERNAME = config.QPILOT_USERNAME
QPILOT_PASSWORD = config.QPILOT_PASSWORD
